...
class SettingTextbox:
    ...
    def __init__(self, root: tk.Toplevel, master_frame: Union[ttk.Frame, tk.Frame]):
        ...
        tk_tooltips(
            ...
            "Max character shown. Keep in mind that the result is also limited by the max buffer and max sentence in the record setting",
        )
        tk_tooltips(
            [
                self.lbl_mw_tc_max_per_line,
                self.spn_mw_tc_max_per_line,
                self.lbl_mw_tl_max_per_line,
                self.spn_mw_tl_max_per_line,
                self.lbl_ex_tc_max_per_line,
                self.spn_ex_tc_max_per_line,
        ...
        tk_tooltips(
            [
                self.cbtn_mw_tc_limit_max,
                self.cbtn_mw_tc_limit_max_per_line,
                self.cbtn_mw_tl_limit_max,
                self.cbtn_mw_tl_limit_max_per_line,
                self.cbtn_ex_tc_limit_max,
                self.cbtn_ex_tc_limit_max_per_line,
                self.cbtn_ex_tl_limit_max,
                self.cbtn_ex_tl_limit_max_per_line,
            ],
    ...
    def configure_commands(self):
        ...
        self.spn_mw_tc_max_per_line.configure(
            command=lambda: sj.save_key("tb_mw_tc_max_per_line", int(self.spn_mw_tc_max_per_line.get()))
            or self.preview_changes_tb()
        )
        ...
        self.spn_mw_tl_max_per_line.configure(
            command=lambda: sj.save_key("tb_mw_tl_max_per_line", int(self.spn_mw_tl_max_per_line.get()))
            or self.preview_changes_tb()
        )
        ...
        self.cbtn_mw_tl_limit_max.configure(
            command=lambda: sj.save_key("tb_mw_tl_limit_max", self.cbtn_mw_tl_limit_max.instate(["selected"]))
            or self.preview_changes_tb()
        )
        ...
        self.spn_ex_tc_max_per_line.configure(
            command=lambda: sj.save_key("tb_ex_tc_max_per_line", int(self.spn_ex_tc_max_per_line.get()))
            or self.preview_changes_tb()
        )
        ...
        self.cbtn_ex_tc_limit_max.configure(
            command=lambda: sj.save_key("tb_ex_tc_limit_max", self.cbtn_ex_tc_limit_max.instate(["selected"]))
            or self.preview_changes_tb()
        )
        self.cbtn_ex_tc_limit_max_per_line.configure(
            command=lambda: sj.save_key(
        ...
        self.spn_ex_tl_max_per_line.configure(
            command=lambda: sj.save_key("tb_ex_tl_max_per_line", int(self.spn_ex_tl_max_per_line.get()))
            or self.preview_changes_tb()
        )
        ...
        self.cbtn_ex_tl_limit_max.configure(
            command=lambda: sj.save_key("tb_ex_tl_limit_max", self.cbtn_ex_tl_limit_max.instate(["selected"]))
            or self.preview_changes_tb()
        )
