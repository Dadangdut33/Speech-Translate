# Modified to make the overall size smaller
...
namespace eval ttk::theme::sv_dark {
	...
	ttk::style theme create sun-valley-dark -parent clam -settings {
		...
		ttk::style configure Toolbutton -padding {4 4} -anchor center -width 12
		...
		ttk::style configure Accent.TButton -padding {1 1} -anchor center -foreground "#000000"
		...
		ttk::style configure TMenubutton -padding {8 4} -width 10
		...
		ttk::style layout TLabelframe {
			Labelframe.border {
				Labelframe.padding -expand 2 -children {
		...
		ttk::style configure TLabelframe.Label -foreground "#9e9e9e"
